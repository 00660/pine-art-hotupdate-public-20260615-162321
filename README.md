...
- Current hosted-runner strategy: build `com.android.art` with `aosp_arm64-user`, keep swap disabled by default, and use diagnostics to track disk pressure. True resume-from-failure requires a self-hosted runner with persistent `android/out`.
